<template>
	<el-row v-for="(item, index) in value" :gutter="24">
		...
		<el-col :span="6">
			<el-button v-if="index === 0" type="primary" size="mini" icon="el-icon-plus" @click="addItem" />
			<el-button type="primary" size="mini" icon="el-icon-delete" @click="deleteItem(index)" />
		</el-col>
